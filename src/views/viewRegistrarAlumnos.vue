<template>
	...
	<div class="paneles">
		...
		<section class="edicion refresh">
			<form @submit.prevet="EditarAlumno(actualizacionAlumno)"> <!-- error 1-->
				...
				<input type="text" placeholder="Esc. Nueva Edad" v-model="form_edit.age">
				  <!-- Lo omiti dar la instruccion de Edicion -->
